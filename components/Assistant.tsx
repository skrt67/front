...
const Assistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Bienvenue chez Aura. Je suis ici pour vous aider à trouver des objets qui résonnent avec votre vie. Comment puis-je vous aider ?', timestamp: Date.now() }
  ]);
