...
const categories = ['Tous', 'Audio', 'Portable', 'Mobile', 'Maison'];
...
const ProductGrid: React.FC<ProductGridProps> = ({ onProductClick }) => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return PRODUCTS.filter(p => p.category === englishCategory);
  }, [activeCategory]);
    ...
    <section id="products" className="py-32 px-6 md:px-12 bg-[#F5F2EB]">
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-24 space-y-8">
          <h2 className="text-4xl md:text-6xl font-serif text-[#2C2A26]">La Collection</h2>
