    ...
    <section id="about" className="bg-[#EBE7DE]">
      ...
      <div className="py-24 px-6 md:px-12 max-w-[1800px] mx-auto flex flex-col md:flex-row items-start gap-16 md:gap-32">
        <div className="md:w-1/3">
          <h2 className="text-4xl md:text-6xl font-serif text-[#2C2A26] leading-tight">
            Né de la terre, <br/> conçu pour l'esprit.
          </h2>
        </div>
        <div className="md:w-2/3 max-w-2xl">
          <p className="text-lg md:text-xl text-[#5D5A53] font-light leading-relaxed mb-8">
            Aura a été fondée sur une prémisse simple mais radicale : la technologie ne devrait pas ressembler à de la technologie. Elle devrait ressembler à une pierre lissée par une rivière, ou à une page tournée dans un livre.
          </p>
          <p className="text-lg md:text-xl text-[#5D5A53] font-light leading-relaxed mb-8">
            À une époque de distraction infinie, nous concevons des objets qui respectent votre silence. Nous utilisons des matériaux qui vieillissent avec grâce—grès, aluminium non traité et coton biologique—créant un pont tactile entre le monde numérique et votre maison physique.
          </p>
          <img 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="order-1 lg:order-2 flex flex-col justify-center p-12 lg:p-24 bg-[#D6D1C7]">
           <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#5D5A53] mb-6">Matérialité</span>
           <h3 className="text-4xl md:text-5xl font-serif mb-8 text-[#2C2A26] leading-tight">
             Des matériaux qui vieillissent <br/> avec grâce.
           </h3>
           <p className="text-lg text-[#5D5A53] font-light leading-relaxed mb-12 max-w-md">
             Nous rejetons le jetable. Chaque produit Aura est fabriqué à partir de grès, d'aluminium non poli et de tissus biologiques qui développent une patine unique au fil du temps, racontant l'histoire de votre utilisation.
           </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        <div className="flex flex-col justify-center p-12 lg:p-24 bg-[#2C2A26] text-[#F5F2EB]">
           ...
           <p className="text-lg text-[#A8A29E] font-light leading-relaxed mb-12 max-w-md">
             Nos appareils respectent votre attention. Pas de lumières clignotantes, pas de notifications intrusives. Juste une utilité calme quand vous en avez besoin, et un bel objet quand vous n'en avez pas.
           </p>
        </div>
